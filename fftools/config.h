...
#define FFMPEG_CONFIGURATION "--prefix=/E/wangshaohui/ffmpeg/build/ --toolchain=msvc --disable-doc --enable-version3 --extra-cflags=-MTd --enable-shared --enable-dxva2 --enable-d3d11va --disable-devices --disable-encoders --enable-encoder=aac --enable-encoder=mpeg4 --disable-muxers --enable-muxer=mp4 --enable-muxer=flv --disable-protocols --enable-protocol=file --enable-protocol=crypto --enable-debug --disable-optimizations"
#define FFMPEG_LICENSE "LGPL version 3 or later"
#define CONFIG_THIS_YEAR 2023
#define FFMPEG_DATADIR "/E/wangshaohui/ffmpeg/build//share/ffmpeg"
#define AVCONV_DATADIR "/E/wangshaohui/ffmpeg/build//share/ffmpeg"
#define CC_IDENT "用于 x64 的 Microsoft (R) C/C++ 优化编译器 19.36.32537 版"
